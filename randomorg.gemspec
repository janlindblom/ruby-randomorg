# -*- encoding: utf-8 -*-
# stub: randomorg 1.0.0d ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [".gitlab-ci.yml".freeze, "CODE_OF_CONDUCT.md".freeze, "Gemfile".freeze, "Jenkinsfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "VERSION".freeze, "lib/random_org.rb".freeze, "lib/random_org/api_client.rb".freeze, "lib/random_org/api_error.rb".freeze, "lib/random_org/api_server_error.rb".freeze, "lib/random_org/argument_error.rb".freeze, "lib/random_org/basic.rb".freeze, "lib/random_org/configuration.rb".freeze, "lib/random_org/response.rb".freeze, "lib/random_org/response/blobs.rb".freeze, "lib/random_org/response/data.rb".freeze, "lib/random_org/response/decimal_fractions.rb".freeze, "lib/random_org/response/gaussians.rb".freeze, "lib/random_org/response/integer_sequences.rb".freeze, "lib/random_org/response/integers.rb".freeze, "lib/random_org/response/random_data.rb".freeze, "lib/random_org/response/strings.rb".freeze, "lib/random_org/response/usage.rb".freeze, "lib/random_org/response/uuids.rb".freeze, "lib/random_org/rng.rb".freeze, "lib/random_org/wrong_api_key_error.rb".freeze, "randomorg.gemspec".freeze]
